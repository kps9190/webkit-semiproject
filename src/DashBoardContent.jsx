...
const DashboardContent = () => {
    ...
    const income = transactions.length > 0
        ...
        : 0;
    const outcome = transactions.length > 0
        ? transactions.filter(t => t.amount < 0).reduce((acc, curr) => acc + curr.amount, 0)
        : 0;
    ...
    return (
        <Layout style={{ height: "100%", width: "100%" }}>
            ...
            <Layout.Content>
                <Row justify="space-evenly" align="middle" gutter={[16, 16]} style={{ width: "100%",marginTop: "30px"}}>
                    <Col flex={1}>
                        <Card style={{ background: "#0092ff", color: "white", textAlign: "center" }} title="수입" varient={"bordered"}>
                            {income.toLocaleString()}원
                        </Card>
                    </Col>
                    <Col flex={1}>
                        <Card style={{ background: "#ffc107", color: "black", textAlign: "center" }} title="지출" variant="filled">
                            {outcome.toLocaleString()}원
                        </Card>
                    </Col>
                    <Col flex={1}>
                        <Card style={{ background: "#e78493", color: "white", textAlign: "center" }} title="총 예산" variant="outlined">
                            {remains.toLocaleString()}원
                        </Card>
                    </Col>
                </Row>
                <Row justify="center" align="middle" gutter={[16, 16]} wrap={false} style={{ width: "100%", marginTop: "30px" }}>
                    <Col flex="1 1 50%">
